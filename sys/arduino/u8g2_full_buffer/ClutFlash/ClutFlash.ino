/*
  ...
  Variant of ClutColor.ino, with tile_clut_map in flash.
  ...
  Strip color change using u8g2_SetClutRegion() does not work, as tile_clut_map is in flash, read-only.
  ...
  - tile_clut_map, 4 bit per 8x8 pixel tile: 240*280/8/8/2 = 520 bytes flash.
  - color lookup table, 16 foreground/background color pairs: 16*2*2 = 64 bytes.
  total: 8464 bytes ram, 520 bytes flash.
...
// captured from ClutColor.ino's writeClutMap("tile_clut_map_0")
// the four different horizontal strips are clearly visible.
// each hex digit is a clut index for a 8x8 tile.
// clang-format off
static const uint8_t tile_clut_map_0[] = {
...
void setup(void) {
  ...
  u8g2_SetClutMap(u8g2.getU8g2(), (uint8_t*)tile_clut_map_0);
